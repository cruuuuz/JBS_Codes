...
class ProgressCollector:
    @staticmethod
    def collect_progress(commodity: str, proxies: dict, year: int, api_key: str) -> pandas.DataFrame:
        ...
        for name, desc in INDICATORS[commodity].items():
            url = (
                ...
                f'&source_desc=SURVEY&short_desc={encode_url_param(desc)}&year__GE={year}'
            )
