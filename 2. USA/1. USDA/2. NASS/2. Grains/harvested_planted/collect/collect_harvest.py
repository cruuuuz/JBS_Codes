from config.commodities_harvest import INDICATORS
...
class HarvestCollector:
    @staticmethod
    def collect_harvest(commodity: str, proxies: dict, year: int, api_key: str) -> pandas.DataFrame:
