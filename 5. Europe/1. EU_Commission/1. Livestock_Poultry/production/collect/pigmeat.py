...
class Pigmeat:
    ...
    def get_Production(base_url: str, proxies: dict, date: str):
        endpoint = "/api/pigmeat/production?"
        params = {
        ...
        df_geral = df_geral[['date', 'memberStateCode', 'memberStateName', 'tonnes', 'heads', 'kgPerHead']]
        df_geral.columns = ['REFERENCE_DATE', 'COUNTRY_CODE', 'COUNTRY_NAME', 'PRODUCTION_THOUSAND_TONS', 'SLAUGHTER_THOUSAND_HEADS', 'KG_WEIGHT_PER_HEAD']
        ...
        df_geral.insert(3, "ANIMAL_TYPE", "HOG/PIGMEAT")
        df_geral.insert(4, "CATEGORY", "")
