...
class Poultry:
    ...
    def get_Production(base_url: str, proxies: dict, date: str):
        endpoint = "/api/poultry/production?"
        params = {
        ...
        df_geral = df_geral[['date', 'memberStateCode', 'memberStateName', 'animal', 'tonnes', 'heads', 'kgPerHead']]
        ...
        df_geral.insert(3, "ANIMAL_TYPE", "POULTRY")
