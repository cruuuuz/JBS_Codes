...
class Beef:
    ...
    def get_Prices(base_url: str, proxies: dict, date: str):
        ...
        df_geral = df_geral.drop(columns='productCode')

        df_geral = df_geral[['endDate', 'beginDate', 'weekNumber', 'memberStateCode', 'memberStateName', 'category', 'price', 'unit']]
        ...
        df_geral.insert(5, "PRODUCT", "BEEF")
